    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final products = (data['products'] as List)
            ...
            .where((product) => product.isValid) // Filter out products with no calorie data
            .toList();
        return products;
      } else {
      ...
      throw Exception('Could not connect to the food database. Please check your connection.');
    }
  }
}